...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ route('home') }}">
            ...
            <div class="sidebar-brand-text mx-3">Platform WPPL</div>
        </a>
        ...
        <li class="nav-item {{ Nav::isRoute('home') }}" style="margin-bottom: 2px">
            ...
            <div class="sub-menu">
                <a class="nav-link" href="{{ route('deliverable') }}" style="margin-top:0px">
        ...
        <footer class="sticky-footer bg-white">
            <div class="container my-auto">
                <div class="copyright text-center my-auto">
                    <span>Copyright &copy; Tim WPPL Platform 2020</span>
                </div>
            </div>
        </footer>
        <!-- End of Footer -->
