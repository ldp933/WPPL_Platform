...
@section('main-content')
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="/materi">Home</a></li>
    ...
    <div class="container">
        <div class="row">
            <div class="col">
            <h1 class="h3 mb-6 text-gray-800">{{ __('List Materi') }}</h1>
            </div>
            <div class="col-md-auto">
            <a class="btn btn-col text-btn-col font-weight-bold" href="/uploadmateri" role="button">Add Materi</a>
            </div>
        </div>
    </div>
    <br>
                                ...
                                <div class="col col-lg-12">
                                    ...
                                    <table class="table">
                                        ...
                                        <tr>
                                            ...
                                            <td>UI/UX</td>
                                            <td><button class="btn"><a href="/detailmateri"><i class="fas fa-eye"></i></a></button>
